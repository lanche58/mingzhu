...
function pageBox() {
	...
	setImgMax($('.pbanner .pic2'), 1920, 1146, w_width, w_height);
	if(w_width<=861){
		var danNum=0;
...
$(function () {
	...
	/* jQuery(".tnav a").click(function(e){
		var $this=jQuery(this);
		var hash = $this.attr("href").split("#")[1];
		if(hash && jQuery("#"+hash).length>=1){
			e.preventDefault();
			jQuery("html,body").animate({ scrollTop: jQuery("#"+hash).offset().top-$headerh},800,'easeInOutExpo');
		}
	}); */
